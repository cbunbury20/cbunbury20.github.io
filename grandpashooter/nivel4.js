...
lib.ssMetadata = [
		{name:"nivel4_atlas_1", frames: [[802,499,733,456],[0,0,1011,497],[1355,0,333,207],[1013,0,340,252],[1159,254,160,122],[1355,209,220,275],[802,957,361,72],[0,499,800,600],[1159,378,74,74],[1013,254,144,179]]}
];
...
(lib.CachedBmp_14 = function() {
	this.initialize(ss["nivel4_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.hit.name = "hit";
	this.hit.setTransform(46,486,0.74,0.5666,0,0,0,0,0.1);
	this.hit._off = true;
	this.hit.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 0, 0, 0)];
	this.hit.cache(-79,-51,138,119);

	this.timeline.addTween(cjs.Tween.get(this.hit).wait(11).to({_off:false},0).wait(1).to({regX:0.1,scaleY:0.9567,x:48,y:499.65},0).wait(1).to({y:538.65},0).wait(1));

	// Layer_3
	this.instance = new lib.Symbol2();
	this.instance.setTransform(41.2,86.55,1,1,0,0,0,41.2,26.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(1).to({y:129},0).wait(1).to({y:171.45},0).wait(1).to({y:213.9},0).wait(1).to({y:256.35},0).wait(1).to({y:298.8},0).wait(1).to({y:341.25},0).wait(1).to({y:383.7},0).wait(1).to({y:426.15},0).wait(1).to({y:468.6},0).wait(1).to({y:511.05},0).wait(1).to({y:553.5},0).wait(1).to({y:595.95},0).wait(1));
	...
	// Layer_6
	this.instance_1 = new lib.darthvadership();
	this.instance_1.setTransform(-18,-9,0.56,0.56);
...
p.nominalBounds = new cjs.Rectangle(-18,-9,123.2,631);
...
// stage content:
(lib.nivel4 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.on("tick", update5.bind(this));
		function update5(evt) {
			//alert("collision")
			//this.caveman.x ++;
			//this.mono1.x += 2
		...
		this.on("tick", update6.bind(this));
		function update6(evt) {
			//alert("collision")
			//this.caveman.x ++;
			//this.mono1.x += 2
		...
		this.on("tick", update7.bind(this));
		function update7(evt) {
			//alert("collision")
			//this.caveman.x ++;
			//this.mono1.x += 2
	...
	this.instance = new lib.ligthsaber();
	this.instance.setTransform(1305.1,616,0.51,1,180);

	this.instance_1 = new lib.ligthsaber();
	this.instance_1.setTransform(53,541,0.51,1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.player},{t:this.enemy1},{t:this.instance_1},{t:this.instance},{t:this.der_btn},{t:this.izq_btn},{t:this.shoot_btn},{t:this.enemy2},{t:this.enemy3},{t:this.mensaje}]}).wait(1));
	...
	this.instance_2.cache(-2,-2,804,693);
...
p.nominalBounds = new cjs.Rectangle(555.1,307,800.4,508.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/nivel4_atlas_1.png", id:"nivel4_atlas_1"}
	],
	preloads: []
};
