...
lib.ssMetadata = [
		{name:"nivel3_atlas_1", frames: [[0,763,1188,660],[0,0,1550,761],[1552,254,333,207],[1552,0,340,252],[1774,463,160,122],[1552,463,220,275],[1190,1365,361,72],[1190,763,800,600],[1936,435,74,74],[1887,254,144,179]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.on("tick", update8.bind(this));
		function update8(evt) {
			//alert("collision")
			//this.caveman.x ++;
			//this.mono1.x += 2
			var pt = this.player.hit.localToLocal(this.player.hit.dot1.x,
		...
		this.on("tick", update9.bind(this));
		function update9(evt) {
			//alert("collision")
			//this.caveman.x ++;
			//this.mono1.x += 2
			var pt = this.player.hit.localToLocal(this.player.hit.dot1.x,
		...
		this.on("tick", update10.bind(this));
		function update10(evt) {
			//alert("collision")
			//this.caveman.x ++;
			//this.mono1.x += 2
			var pt = this.player.hit.localToLocal(this.player.hit.dot1.x,
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/nivel3_atlas_1.png?1610773401723", id:"nivel3_atlas_1"}
	],
	preloads: []
};
