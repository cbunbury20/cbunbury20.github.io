...
lib.ssMetadata = [
		{name:"nivel2_atlas_1", frames: [[802,499,733,456],[0,0,1011,497],[1355,0,333,207],[1013,0,340,252],[1159,254,160,122],[1355,209,220,275],[802,957,361,72],[0,499,800,600],[1159,378,74,74],[1013,254,144,179]]}
];
...
(lib.CachedBmp_26 = function() {
	this.initialize(ss["nivel2_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[]},240).wait(20));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.instance = new lib.empireshipgold();
	this.instance.setTransform(-1,2,0.38,0.38);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.enemy1, new cjs.Rectangle(-1,2,83.6,104.5), null);
...
// stage content:
(lib.nivel2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function update5(evt) {
			...
			//this.mono1.x += 2
			var pt = this.player.hit.localToLocal(this.player.hit.dot1.x,
				this.player.hit.dot1.y, this.enemy4.box);
			if (this.enemy4.box.hitTest(pt.x, pt.y)) {
				//alert("collision")
				this.enemy4.x = -1000
				deadenemies ++
				//alert(deadenemies)
		...
		function update6(evt) {
			...
			//this.mono1.x += 2
			var pt = this.player.hit.localToLocal(this.player.hit.dot1.x,
				this.player.hit.dot1.y, this.enemy5.box);
			if (this.enemy5.box.hitTest(pt.x, pt.y)) {
				//alert("collision")
				this.enemy5.x = -1000
				deadenemies ++
				//alert(deadenemies)
		...
		function update7(evt) {
			...
			//this.mono1.x += 2
			var pt = this.player.hit.localToLocal(this.player.hit.dot1.x,
				this.player.hit.dot1.y, this.enemy6.box);
			if (this.enemy6.box.hitTest(pt.x, pt.y)) {
				//alert("collision")
				this.enemy6.x = -1000
				deadenemies ++
				//alert(deadenemies)
	...
	this.enemy4.setTransform(993.4,157.8,1,1,0,0,0,41.8,52.3);

	this.enemy6 = new lib.enemy1();
	this.enemy6.name = "enemy6";
	this.enemy6.setTransform(1299.3,157.8,1,1,0,0,0,41.8,52.3);

	this.enemy5 = new lib.enemy1();
	this.enemy5.name = "enemy5";
	this.enemy5.setTransform(1147.35,157.8,1,1,0,0,0,41.8,52.3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.player},{t:this.enemy1},{t:this.instance_1},{t:this.instance},{t:this.der_btn},{t:this.izq_btn},{t:this.shoot_btn},{t:this.enemy2},{t:this.enemy3},{t:this.mensaje},{t:this.enemy5},{t:this.enemy6},{t:this.enemy4}]}).wait(1));
