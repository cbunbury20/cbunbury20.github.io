...
lib.ssMetadata = [
		{name:"game3_atlas_1", frames: [[0,0,944,937],[946,0,944,937],[1024,939,443,101],[802,939,220,275],[1469,939,361,72],[0,939,800,600],[1892,181,74,74],[1892,0,144,179]]}
];
...
(lib.CachedBmp_3 = function() {
	this.initialize(ss["game3_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.game3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.player},{t:this.enemy1},{t:this.instance_4},{t:this.instance_3},{t:this.der_btn},{t:this.izq_btn},{t:this.shoot_btn}]},1).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/game3_atlas_1.png?1610747766742", id:"game3_atlas_1"}
	],
	preloads: []
};
